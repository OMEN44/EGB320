_pixi() {
    ...
    do
        case "${cmd},${i}" in
            ...
            pixi__global__help,sync)
                ...
                ;;
            pixi__global__help,tree)
                cmd="pixi__global__help__tree"
                ;;
            ...
            pixi__help__global,sync)
                ...
                ;;
            pixi__help__global,tree)
                cmd="pixi__help__global__tree"
                ;;
    ...
    case "${cmd}" in
        pixi)
            opts="-h -v -q -V --help --verbose --quiet --color --no-progress --list --version add a auth build clean completion config exec x global g info init import install i list ls lock reinstall remove rm run r search self-update shell s shell-hook task tree t update upgrade upload workspace help"
            ...
            ;;
        pixi__add)
            opts="-p -f -g -s -h -v -q --manifest-path --host --build --pypi --platform --feature --git --branch --tag --rev --subdir --no-install --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --editable --help --verbose --quiet --color --no-progress <SPEC>..."
        ...
        pixi__auth__logout)
            ...
            ;;
        pixi__build)
            opts="-t -o -b -c -h -v -q --manifest-path --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --target-platform --build-platform --output-dir --build-dir --clean --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__global)
            ...
            ;;
        pixi__global__add)
            opts="-e -h -v -q --git --branch --tag --rev --subdir --path --environment --expose --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress [PACKAGE]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__help__workspace__version__set)
            ...
            ;;
        pixi__import)
            opts="-p -e -f -h -v -q --manifest-path --format --platform --environment --feature --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress <FILE>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__init)
            ...
            ;;
        pixi__install)
            opts="-e -a -h -v -q --manifest-path --frozen --locked --environment --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --all --skip --skip-with-deps --only --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__list)
            opts="-e -x -h -v -q --platform --json --json-pretty --sort-by --manifest-path --environment --no-lockfile-update --frozen --locked --no-install --explicit --help --verbose --quiet --color --no-progress [REGEX]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__lock)
            opts="-h -v -q --manifest-path --no-install --json --check --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__self__update)
            ...
            ;;
        pixi__shell)
            opts="-e -h -v -q --manifest-path --no-install --no-lockfile-update --frozen --locked --as-is --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --environment --change-ps1 --force-activate --no-completions --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        pixi__shell__hook)
            opts="-s -e -h -v -q --shell --manifest-path --no-install --no-lockfile-update --frozen --locked --as-is --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --force-activate --no-completions --environment --json --change-ps1 --help --verbose --quiet --color --no-progress"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__task__remove)
            ...
            ;;
        pixi__tree)
            opts="-p -e -i -h -v -q --platform --manifest-path --environment --no-lockfile-update --frozen --locked --no-install --invert --help --verbose --quiet --color --no-progress [REGEX]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__update)
            ...
            ;;
        pixi__upgrade)
            opts="-f -n -h -v -q --manifest-path --no-install --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --feature --exclude --json --dry-run --help --verbose --quiet --color --no-progress [PACKAGES]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__workspace__channel__add)
            opts="-f -h -v -q --manifest-path --priority --prepend --no-install --no-lockfile-update --frozen --locked --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --feature --help --verbose --quiet --color --no-progress <CHANNEL>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pixi__workspace__export__conda__explicit__spec)
            opts="-e -p -h -v -q --manifest-path --environment --platform --ignore-pypi-errors --ignore-source-errors --no-lockfile-update --frozen --locked --no-install --auth-file --concurrent-downloads --concurrent-solves --pinning-strategy --pypi-keyring-provider --run-post-link-scripts --tls-no-verify --use-environment-activation-cache --help --verbose --quiet --color --no-progress <OUTPUT_DIR>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
